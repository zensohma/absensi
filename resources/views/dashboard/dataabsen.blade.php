            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="dataabsen.html"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="arsipdataabsen.html"
                                aria-expanded="false">
                                <i class="fas fa-arrow-up-right-from-square ps-3"
                                    style="font-size: 20px; margin-right: 10px;"></i>
                                <span class="hide-menu" style="margin-left: 5px;">Arsip Data Absen</span>
                            </a>
                        </li>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body " style="border-radius: 10px;">
                                                    <label for="selectBarang" class="form-label">Nama</label>
                                                    <input type="text" class="form-control" id="Nama" name="Nama"
                                                        placeholder="masukkan nama anda">

                                                    <label for="selectBarang" class="form-label">Tanggal Absen</label>
